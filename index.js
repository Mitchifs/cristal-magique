...
const anecdote = [
	...
	"Tip#11 : Sois gentil, pas méchant, c'est pas gentil d'être méchant",
	"Tip#12 : Dors au moins 7 heures par jour",
	"Certainement pas .",
	"Encore une idée de merde...",
	"Wopputaingue de meiirde",
	"```for i := 1 to 3 do\n	writeln(i);\nwriteln('Soleil !');```",
	"TA TA TAAAAM !!!",
	"Tu aimes les rats ? Moi oui. Nan jrigole",
	"Imagine là ton pc il s'éteint au moment où tu lis ce message",
	"1\n2\n3\nSoleil !",
	"Pas d'inspi",
	":point_up: La personne au dessus de moi est EXTRAORDINAIRE",
	":point_up: La personne au dessus de moi est A CHIER",
	":point_up: La personne au dessus de moi est A LOUER",
	":point_up: La personne au dessus de moi est ADORABLE",
	":point_up: La personne au dessus de moi est TROP MIGNONNE !",
	":point_up: La personne au dessus de moi est DEGUEULASSE",
	":point_up: La personne au dessus de moi est ADORABLE",
	":point_up: La personne au dessus de moi est TRISTE",
	":point_up: La personne au dessus de moi est DEBILE",
	":point_up: La personne au dessus de moi est RIEN",
	":point_up: La personne au dessus de moi est UNE GROSSE MERDE",
	":point_up: La personne au dessus de moi est UN SCHLAG",
	":point_up: La personne au dessus de moi est SYMPATHIQUE",
	":point_up: La personne au dessus de moi est LEGENDAIRE",
	":point_up: La personne au dessus de moi est BEURK",
	":point_up: La personne au dessus de moi est PAS UN ETRE HUMAIN",
	":point_up: La personne au dessus de moi est LA PERSONNE AU DESSUS DE MOI",
	":point_up: La personne au dessus de moi est INSUPPORTABLE",
	":point_up: La personne au dessus de moi est ETRANGE",
	":point_up: La personne au dessus de moi est VRAIMENT LAIDE",
	":point_up: La personne au dessus de moi est TRES BELLE",
...
bot.on("ready", async () => {
	...
	bot.setInterval(async () => {
		...
		const semainesG2PresentielMatin = new Set([5,7,11,13,16,21,23])
		const semainesG2PresentielAprem = new Set([4,6,10,12,15,20,22])
